...
class QA_Example_Page_Page extends Q2A_Plugin_Module_Page
{
	public function getInternalId()
	{
		return 'QA_Example_Page_Page';
	}

	public function getSuggestedRequests() // for display in admin interface
	{
		return array(
			array(
				'title' => 'Example',
