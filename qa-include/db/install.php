	...
	*/
		...
		$tables=array(
			'users' => array(
				...
				'createip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address when created
				...
				'loginip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address of last login
				'written' => 'DATETIME', // time of last write action done by user
				'writeip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address of last write action done by user
			...
			'cookies' => array(
				...
				'created' => 'DATETIME NOT NULL',
				'createip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address when cookie created
				'written' => 'DATETIME', // time of last write action done by anon user with cookie
				'writeip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address of last write action done by anon user with cookie
			...
			'posts' => array(
				...
				'createip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address used to create the post
				'lastuserid' => $useridcoltype, // which user last modified it
				'lastip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address which last modified the post
				...
				'lastviewip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address which last viewed the post
			...
			'blobs' => array(
				...
				'createip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address that created it
			...
			'iplimits' => array(
				'ip' => 'VARBINARY(16) NULL DEFAULT NULL', // INET_ATON of IP address
