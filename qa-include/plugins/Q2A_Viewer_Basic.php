...
class Q2A_Viewer_Basic extends Q2A_Plugin_Module_Viewer
{
	public function getInternalId()
	{
		return 'Q2A_Viewer_Basic';
	}

	private $htmlLineSeparators = 'br|option';
	private $htmlParagraphSeparators  = 'address|applet|blockquote|center|cite|col|div|dd|dl|dt|embed|form|frame|frameset|h1|h2|h3|h4|h5|h6|hr|iframe|input|li|marquee|ol|p|pre|samp|select|spacer|table|tbody|td|textarea|tfoot|th|thead|tr|ul';
	...
	public function getHtml($content, $format, $options)
	{
		if ($format=='html') {
	...
	public function getText($content, $format, $options)
	{
		if ($format=='html') {
