...
*/
	...
	return array(
		...
		'categories_not_shown' => 'Some situations have categories which will not be displayed.',
		...
		'category_no_sub_error' => '^q situation/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move situations in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q situation/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move situations with no category to:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its situations to:',
		...
		'delete_hidden_note' => ' - all hidden situations, idea and comments without dependents',
		...
		'hidden_answers_deleted' => 'Deleted ^1 of ^2 hidden ideas without dependents...',
		'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden comments...',
		'hidden_questions_deleted' => 'Deleted ^1 of ^2 hidden situations without dependents...',
		'hidden_title' => 'Hidden',
		'hotness_factors' => 'Relative importance for situation hotness:',
		...
		'question_lists' => 'Situation lists',
		'question_pages' => 'Situation pages',
		...
		'recalc_categories_recounting' => 'Recounting situations for ^1 of ^2 categories...',
		...
		'recalc_posts_count' => 'Getting total number of situations, ideas and comments...',
		...
		'recount_posts_as_recounted' => 'Recounted ideas and hotness for ^1 of ^2 posts...',
		'recount_posts_complete' => 'All posts were successfully recounted.',
		'recount_posts_note' => ' - the number of ideas, votes, flags and hotness for each post',
		...
		'refill_events_refilled' => 'Refilled for ^1 of ^2 situations...',
		'registration_fields' => 'add registration fields',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related situation suggestions',
		...
		'tags_not_shown' => 'Some situations have tags which will not be displayed.',
		...
		'total_as' => 'Total ideas:',
		'total_cs' => 'Total comments:',
		'total_qs' => 'Total situations:',
