...
*/
	...
	return array(
		...
		'add_q_favorites' => 'Add this situation to my favorites',
		...
		'answer_must_be_approved' => 'Your account must be approved before you answer a situation.',
		'answer_must_confirm' => 'Please ^5confirm your email address^6 to answer this situation.',
		'answer_must_login' => 'Please ^1log in^2 or ^3register^4 to answer this situation.',
		'answer_q_popup' => 'Answer this situation',
		'approve_a_popup' => 'Approve this answer',
		'approve_button' => 'approve',
		'approve_c_popup' => 'Approve this comment',
		'approve_q_popup' => 'Approve this situation',
		'ask_button' => 'Ask the Situation',
		'ask_follow_from_a' => 'Your situation will be related to this answer:',
		'ask_follow_title' => 'Ask a related situation',
		'ask_limit' => 'Too many questions received - please try again in an hour',
		'ask_must_be_approved' => 'Your account must be approved before you ask a situation.',
		'ask_must_confirm' => 'Please ^5confirm your email address^6 to ask a situation.',
		'ask_must_login' => 'Please ^1log in^2 or ^3register^4 to ask a situation.',
		'ask_same_q' => 'Before proceeding, please check your situation was not asked already:',
		'ask_title' => 'Ask a situation',
		...
		'claim_q_popup' => 'Assign this situation to your user account',
		'clear_flags_button' => 'clear flags',
		'clear_flags_popup' => 'Remove flags by all users',
		'close_button' => 'close',
		'close_duplicate' => 'This is a duplicate of another situation',
		'close_duplicate_error' => 'The duplicate situation could not be found - please try entering the number from a different situation URL, e.g. 123.',
		'close_form_button' => 'Close situation',
		'close_form_title' => 'Close this situation',
		'close_original_note' => 'You can also enter the situation number from the URL, e.g. 123.',
		'close_original_title' => 'URL of the original situation:',
		'close_q_popup' => 'Close this situation to any new answers',
		'close_reason_title' => 'Reason for closing this situation:',
		...
		'comment_on_q' => 'On situation: ',
		'comment_q_popup' => 'Add a comment on this situation',
		'delete_a_popup' => 'Delete this answer permanently',
		'delete_button' => 'delete',
		'delete_c_popup' => 'Delete this comment permanently',
		'delete_q_popup' => 'Delete this situation permanently',
		...
		'edit_q_popup' => 'Edit this situation',
		'edit_q_title' => 'Edit Situation',
		...
		'flag_q_popup' => 'Flag this situation as spam or inappropriate',
		'follow_a_popup' => 'Ask a new situation relating to this answer',
		'follow_button' => 'ask related situation',
		'follows_a' => 'related to an answer for:',
		'follows_q' => 'about the situation:',
		'hide_a_popup' => 'Hide this answer',
		'hide_button' => 'hide',
		'hide_c_popup' => 'Hide this comment',
		'hide_q_popup' => 'Hide this situation',
		...
		'q_content_label' => 'More information for the situation:',
		'q_hidden_author' => 'This situation has been hidden by its author',
		'q_hidden_flagged' => 'This situation has been flagged and hidden',
		'q_hidden_other' => 'This situation has been hidden',
		'q_notify_email' => 'Email me at this address if my situation is answered or commented on:',
		'q_notify_label' => 'Email me if my situation is answered or commented on',
		'q_notify_x_label' => 'Email me (^) if my situation is answered or commented on',
		'q_tags_comma_label' => 'Tags - use comma (,) as a separator:',
		'q_tags_label' => 'Tags - use hyphens to combine words:',
		'q_title_label' => 'The situation in one sentence:',
		'q_waiting_approval' => 'This situation is waiting for approval',
		'q_waiting_your_approval' => 'This situation is waiting for your approval',
		'q_your_waiting_approval' => 'Your situation will be checked and approved shortly.',
		'recat_button' => 'recategorize',
		'recat_popup' => 'Change this situation\'s category',
		'recat_q_title' => 'Recategorize situation',
		'reject_a_popup' => 'Reject this answer',
		'reject_button' => 'reject',
		'reject_c_popup' => 'Reject this comment',
		'reject_q_popup' => 'Reject this situation',
		'remove_q_favorites' => 'Remove this situation from my favorites',
		'reopen_button' => 'reopen',
		'reopen_q_popup' => 'Reopen this situation',
		'reply_button' => 'reply',
		...
		'reshow_q_popup' => 'Reshow this situation',
		'retag_button' => 'retag',
		'retag_cat_popup' => 'Change this situation\'s category or tags',
		'retag_popup' => 'Change this situation\'s tags',
		'retag_q_title' => 'Retag situation',
		...
		'your_comment_q' => 'Your comment on this situation:',
	);
