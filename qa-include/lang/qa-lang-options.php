...
*/
	...
	return array(
		...
		'allow_close_questions' => 'Allow situations to be manually closed:',
		'allow_login_email_only' => 'Only log in by email address (not username):',
		'allow_multi_answers' => 'Allow multiple ideas per user:',
		'allow_no_category' => 'Allow situations with no category',
		'allow_no_sub_category' => 'Allow situations with a category but no sub-category',
		'allow_private_messages' => 'Enable private messaging between users:',
		'allow_self_answer' => 'Allow users to idea their own situation:',
		'allow_user_walls' => 'Enable wall posts on user profiles:',
		'allow_view_q_bots' => 'Allow search engines to view situation pages',
		...
		'avatar_q_list_size' => 'Avatar size on situation lists:',
		'avatar_q_page_a_size' => 'Avatar size on ideas:',
		'avatar_q_page_c_size' => 'Avatar size on comments:',
		'avatar_q_page_q_size' => 'Avatar size on situations:',
		...
		'comment_on_as' => 'Allow comments on ideas:',
		'comment_on_qs' => 'Allow comments on situations:',
		...
		'default_sidebar' => 'Welcome to ^, where you can ask situations and receive ideas from other members of the community.',
		'default_subject' => 'A message from ^',
		'default_suffix' => 'Q&A',
		'default_terms' => 'I agree to the ^ Terms & Conditions and Privacy Policy',
		'do_ask_check_qs' => 'Check for similar situations when asking:',
		'do_close_on_select' => 'Close situations with a selected idea:',
		'do_complete_tags' => 'Show matching tags while typing:',
		'do_count_q_views' => 'Count the number of situation views:',
		'do_example_tags' => 'Show example tags based on situation:',
		'editor_for_as' => 'Default editor for ideas:',
		'editor_for_cs' => 'Default editor for comments:',
		'editor_for_qs' => 'Default editor for situations:',
		...
		'extra_field_display' => 'Show the extra information on situation pages',
		'extra_field_display_label' => 'Show the extra information on situation pages with label:',
		'feed_for_activity' => 'Feed for recent activity:',
		'feed_for_hot' => 'Feed for hot situations:',
		'feed_for_qa' => 'Feed for recent situations and ideas:',
		'feed_for_questions' => 'Feed for recent situations:',
		'feed_for_search' => 'Feeds for search results:',
		'feed_for_tag_qs' => 'Feed for each tag\'s situations:',
		'feed_for_unanswered' => 'Feed for situations with no ideas:',
		...
		'follow_on_as' => 'Allow situations to be related to ideas:',
		'from_email' => 'Sender address for messages from site:',
		'hot_weight_a_age' => 'Situation has a new idea:',
		'hot_weight_answers' => 'Situation has many ideas:',
		'hot_weight_q_age' => 'Situation is new:',
		'hot_weight_views' => 'Situation has many views:',
		'hot_weight_votes' => 'Situation has many up votes:',
		...
		'match_4' => 'Wider',
		'match_5' => 'Widest',
		'match_ask_check_qs' => 'Similar situations matching:',
		'match_example_tags' => 'Example tags matching:',
		'match_related_qs' => 'Related situations matching:',
		'max_len_q_title' => 'Maximum length of situation title:',
		'max_num_q_tags' => 'Maximum number of tags:',
		'max_rate_ip_as' => 'Rate limit for adding ideas:',
		...
		'max_rate_ip_qs' => 'Rate limit for asking situations:',
		...
		'max_rate_user_as' => 'Maximum ideas per user per hour:',
		...
		'max_rate_user_qs' => 'Maximum situations per user per hour:',
		'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
		'max_rate_user_votes' => 'Maximum votes per user per hour:',
		'min_len_a_content' => 'Minimum length of idea:',
		'min_len_c_content' => 'Minimum length of comment:',
		'min_len_q_content' => 'Minimum length of situation body:',
		'min_len_q_title' => 'Minimum length of situation title:',
		...
		'notify_admin_q_post' => 'Email this address when a situation is posted',
		'notify_users_default' => 'Check email notification box by default:',
		'option_default' => 'Default',
		'page_size_activity' => 'Length of All Activity page:',
		'page_size_ask_check_qs' => 'Maximum similar situations to show:',
		...
		'page_size_q_as' => 'Maximum ideas per page:',
		'page_size_qs' => 'Length of Situations page:',
		'page_size_related_qs' => 'Maximum related situations:',
		'page_size_search' => 'Search results per page:',
		'page_size_tag_qs' => 'Situations on each tag page:',
		'page_size_tags' => 'Length of Tags page:',
		'page_size_una_qs' => 'Length of No Ideas page:',
		...
		'points_a_selected' => 'Having your idea selected as the best:',
		'points_a_voted_max_gain' => 'Limit from up votes on each idea:',
		'points_a_voted_max_loss' => 'Limit from down votes on each idea:',
		'points_base' => 'Add for all users:',
		'points_multiple' => 'Multiply all points:',
		'points_per_a_voted_down' => 'Per down vote on your idea:',
		'points_per_a_voted_up' => 'Per up vote on your idea:',
		'points_per_q_voted_down' => 'Per down vote on your situation:',
		'points_per_q_voted_up' => 'Per up vote on your situation:',
		'points_post_a' => 'Posting an idea:',
		'points_post_q' => 'Posting a situation:',
		'points_q_voted_max_gain' => 'Limit from up votes on each situation:',
		'points_q_voted_max_loss' => 'Limit from down votes on each situation:',
		'points_select_a' => 'Selecting an idea for your situation:',
		'points_vote_down_a' => 'Voting down an idea:',
		'points_vote_down_q' => 'Voting down a situation:',
		'points_vote_up_a' => 'Voting up an idea:',
		'points_vote_up_q' => 'Voting up a situation:',
		'q_urls_remove_accents' => 'Remove accents from situation URLs:',
		'q_urls_title_length' => 'Situation title length in URLs:',
		'register_notify_admin' => 'Email me when a new user registers:',
		'search_module' => 'Use search module:',
		'show_a_form_immediate' => 'Show idea form immediately:',
		'show_always' => 'Always',
		'show_c_reply_buttons' => 'Show reply button on comments:',
		'show_custom_answer' => 'Custom message on idea form - HTML allowed:',
		...
		'show_selected_first' => 'Move selected idea to the top:',
		...
		'show_view_count_q_page' => 'Show view count on situation pages:',
		'show_view_counts' => 'Show view count in situation lists:',
